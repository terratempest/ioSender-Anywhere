...
public static class WorkspaceEditorCatalog
{
    ...
    [
        ...
        Desc(WorkspaceEditorId.Mdi, "CNC.Controls.WPF.mdicontrol.grp_mdi", "MDI", 200, 100),
        Desc(WorkspaceEditorId.MdiTouch, "ioSender.workspace.editor_mdiTouch", "MDI (Touch)", 360, 250, fillsWorkspace: true),
        Desc(WorkspaceEditorId.Dro, "CNC.Controls.WPF.drocontrol.grp_dro", "DRO", 160, 120, fillsWorkspace: true),
        Desc(WorkspaceEditorId.Signals, "ioSender.workspace.editor_signals", "Signals", 216, 60, fillsWorkspace: true),
        Desc(WorkspaceEditorId.Status, "ioSender.workspace.editor_status", "Status", 216, 66),
        ...
        Desc(WorkspaceEditorId.Spindle, "ioSender.workspace.editor_spindle", "Spindle", 220, 200, fillsWorkspace: true),
        Desc(WorkspaceEditorId.Coolant, "ioSender.workspace.editor_coolant", "Coolant", 250, 80),
        Desc(WorkspaceEditorId.Feed, "ioSender.workspace.editor_feed", "Feed", 220, 200, fillsWorkspace: true),
